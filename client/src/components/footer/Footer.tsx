...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      viewport={{ once: true }}
      className={`bg-[#008080] text-white dark:text-white dark:bg-[#161929]
      w-full font-roboto dark:border-t-[2px] border-solid
      border-gray-400 pt-8 lg:pt-10 xl:pt-14 2xl:pt-[70px] pb-3 space-y-8 lg:space-y-14 xl:space-y-20
      ${isHome ? "mt-20 lg:mt-28 xl:mt-40" : "mt-10 lg:mt-14 xl:mt-20"}`}
    >
      <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left">
        ...
        <div>
          ...
          <p className=" text-sm lg:text-lg xl:text-xl leading-relaxed max-md:max-w-xl">
        ...
        <div className="space-x-4 md:space-y-4 flex md:flex-col items-center max-md:justify-center">
          <h3 className="paragraph-text font-semibold mb-2">Follow Us</h3>
          <nav
