...
const Navbar = () => {
            ...
            className={`w-full font-roboto relative transition-all duration-300 ${
              showTopBar
                ? isTransparent
                  ...
                  : "translate-y-0 bg-[#006666] dark:bg-[#161929] shadow"
                : "-translate-y-[45px] md:-translate-y-[58px] bg-[#006666] text-gray-950 dark:bg-[#161929] shadow mt-5"
            }`}
          >
                      ...
                      >
                        ...
                        <div
                          className="absolute top-full left-1/2 -translate-x-1/2 group-hover:block hidden
                                     ...
                                     bg-[#006666] rounded-md dark:bg-[#161929] shadow-xl transition-all duration-300 ease-out animate-fadeInUp"
                        >
  ...
  `}
        ...
        {menuOpen && (
          <motion.div
            ref={mobileMenuRef}
            className={`md:hidden bg-[#006666] dark:bg-[#161929] shadow-lg py-1 absolute z-50 w-32 sm:w-40 text-center sm:text-right right-0
              ${
          ...
          `}
                ...
                {item.dropdown && openDropdownIndex === index && (
                  <motion.div
                    className="absolute z-50 right-[129px] sm:right-[160.50px] top-[18px] bg-[#006666] dark:bg-[#161929] group-hover:block shadow-lg rounded-md w-auto space-y-2 py-2"
                    initial={{ opacity: 0, x: -10 }}
                    animate={{ opacity: 1, x: 0 }}
                    exit={{ opacity: 0, x: -10 }}
                    transition={{ duration: 0.3, ease: "easeInOut" }}
